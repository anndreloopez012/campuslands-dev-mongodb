...
```bash
docker pull ghcr.io/anndreloopez012/campuslands-dev-mongodb:dev
docker run --rm -p 8090:80 ghcr.io/anndreloopez012/campuslands-dev-mongodb:dev
```
...
- Documentacion: `http://localhost:8090`
...
- `dev` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-mongodb:dev`.
- `main` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-mongodb:latest`.
