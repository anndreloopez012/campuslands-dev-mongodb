...
|---|---|---|
| `campuslands-package` | Navegar la documentacion y archivos del repo | `http://localhost:8090` |
| `mongo` | Base de datos MongoDB local | `localhost:27018` |
| `mongo-express` | Interfaz web para ver/editar la BD | `http://localhost:8082` |
...
```text
mongodb://campus_admin:campus_admin_123@localhost:27018/admin
```
...
```text
mongodb://campus_student:campus_student_123@localhost:27018/campuslands?authSource=campuslands
```
...
```bash
mongosh "mongodb://campus_student:campus_student_123@localhost:27018/campuslands?authSource=campuslands"
```
