# Ejercicio 041 - MongoDB Facil: pingpong
...
```javascript
db.products.insertOne({ nombre: 'demo-41', puntos: 287, activo: true })
```

```javascript
db.products.find({ puntos: { $gte: 205 } }, { nombre: 1, puntos: 1, _id: 0 })
```
