# Ejercicio 016 - MongoDB Facil: ciencia ficcion
...
```javascript
db.players.insertOne({ nombre: 'demo-16', puntos: 112, activo: true })
```

```javascript
db.players.find({ puntos: { $gte: 80 } }, { nombre: 1, puntos: 1, _id: 0 })
```
