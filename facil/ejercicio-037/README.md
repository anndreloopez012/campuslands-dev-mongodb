# Ejercicio 037 - MongoDB Facil: autos de lujo
...
Proyectar campos utiles usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
db.movies.insertOne({ nombre: 'demo-37', puntos: 259, activo: true })
```

```javascript
db.movies.find({ puntos: { $gte: 185 } }, { nombre: 1, puntos: 1, _id: 0 })
```
