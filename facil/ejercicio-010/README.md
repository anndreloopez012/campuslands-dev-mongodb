# Ejercicio 010 - MongoDB Facil: hiperdeportivos
...
Documentar comandos usados usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
db.events.insertOne({ nombre: 'demo-10', puntos: 70, activo: true })
```

```javascript
db.events.find({ puntos: { $gte: 50 } }, { nombre: 1, puntos: 1, _id: 0 })
```
