# Ejercicio 029 - MongoDB Facil: esports shooter
...
Usar operadores de comparacion usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
db.teams.insertOne({ nombre: 'demo-29', puntos: 203, activo: true })
```

```javascript
db.teams.find({ puntos: { $gte: 145 } }, { nombre: 1, puntos: 1, _id: 0 })
```
