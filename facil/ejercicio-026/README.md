# Ejercicio 026 - MongoDB Facil: arquitectura 3D
...
Ordenar resultados usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
use campus_arquitectura_3D
```

```javascript
db.products.insertOne({ nombre: 'demo-26', puntos: 182, activo: true })
```

```javascript
db.products.find({ puntos: { $gte: 130 } }, { nombre: 1, puntos: 1, _id: 0 })
```
