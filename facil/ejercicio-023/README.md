# Ejercicio 023 - MongoDB Facil: tatuajes
...
Consultar documentos con filtros simples usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
db.tracks.insertOne({ nombre: 'demo-23', puntos: 161, activo: true })
```

```javascript
db.tracks.find({ puntos: { $gte: 115 } }, { nombre: 1, puntos: 1, _id: 0 })
```
