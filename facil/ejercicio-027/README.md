# Ejercicio 027 - MongoDB Facil: soldadura
...
```javascript
use campus_soldadura
```

```javascript
db.bookings.insertOne({ nombre: 'demo-27', puntos: 189, activo: true })
```

```javascript
db.bookings.find({ puntos: { $gte: 135 } }, { nombre: 1, puntos: 1, _id: 0 })
```
