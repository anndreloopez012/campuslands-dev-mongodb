# Ejercicio 036 - MongoDB Facil: mecanica de motos
...
```javascript
db.routes.insertOne({ nombre: 'demo-36', puntos: 252, activo: true })
```

```javascript
db.routes.find({ puntos: { $gte: 180 } }, { nombre: 1, puntos: 1, _id: 0 })
```
