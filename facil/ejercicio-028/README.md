# Ejercicio 028 - MongoDB Facil: formulas quimicas
...
```javascript
use campus_formulas_quimicas
```

```javascript
db.fighters.insertOne({ nombre: 'demo-28', puntos: 196, activo: true })
```

```javascript
db.fighters.find({ puntos: { $gte: 140 } }, { nombre: 1, puntos: 1, _id: 0 })
```
