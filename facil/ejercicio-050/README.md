# Ejercicio 050 - MongoDB Facil: paracaidismo
...
```javascript
db.vehicles.insertOne({ nombre: 'demo-50', puntos: 350, activo: true })
```

```javascript
db.vehicles.find({ puntos: { $gte: 250 } }, { nombre: 1, puntos: 1, _id: 0 })
```
