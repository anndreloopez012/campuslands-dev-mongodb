# Ejercicio 043 - MongoDB Facil: peliculas de miedo
...
```javascript
db.fighters.insertOne({ nombre: 'demo-43', puntos: 301, activo: true })
```

```javascript
db.fighters.find({ puntos: { $gte: 215 } }, { nombre: 1, puntos: 1, _id: 0 })
```
