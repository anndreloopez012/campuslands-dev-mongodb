# Ejercicio 039 - MongoDB Facil: kickboxing
...
```javascript
db.sessions.insertOne({ nombre: 'demo-39', puntos: 273, activo: true })
```

```javascript
db.sessions.find({ puntos: { $gte: 195 } }, { nombre: 1, puntos: 1, _id: 0 })
```
