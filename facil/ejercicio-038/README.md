# Ejercicio 038 - MongoDB Facil: hiperdeportivos
...
```javascript
use campus_hiperdeportivos
```

```javascript
db.tracks.insertOne({ nombre: 'demo-38', puntos: 266, activo: true })
```

```javascript
db.tracks.find({ puntos: { $gte: 190 } }, { nombre: 1, puntos: 1, _id: 0 })
```
