# Ejercicio 011 - MongoDB Facil: kickboxing
...
```javascript
use campus_kickboxing
```

```javascript
db.products.insertOne({ nombre: 'demo-11', puntos: 77, activo: true })
```

```javascript
db.products.find({ puntos: { $gte: 55 } }, { nombre: 1, puntos: 1, _id: 0 })
```
