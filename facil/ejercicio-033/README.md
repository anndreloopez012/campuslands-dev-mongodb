# Ejercicio 033 - MongoDB Facil: futbol
...
```javascript
db.inventory.insertOne({ nombre: 'demo-33', puntos: 231, activo: true })
```

```javascript
db.inventory.find({ puntos: { $gte: 165 } }, { nombre: 1, puntos: 1, _id: 0 })
```
