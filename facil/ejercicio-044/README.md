# Ejercicio 044 - MongoDB Facil: ciencia ficcion
...
Actualizar campos concretos usando MongoDB y dejando evidencia clara de los comandos ejecutados.
...
```javascript
use campus_ciencia_ficcion
```

```javascript
db.teams.insertOne({ nombre: 'demo-44', puntos: 308, activo: true })
```

```javascript
db.teams.find({ puntos: { $gte: 220 } }, { nombre: 1, puntos: 1, _id: 0 })
```
