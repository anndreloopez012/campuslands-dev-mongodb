# Ejercicio 034 - MongoDB Facil: futbol sala
...
```javascript
use campus_futbol_sala
```

```javascript
db.orders.insertOne({ nombre: 'demo-34', puntos: 238, activo: true })
```

```javascript
db.orders.find({ puntos: { $gte: 170 } }, { nombre: 1, puntos: 1, _id: 0 })
```
