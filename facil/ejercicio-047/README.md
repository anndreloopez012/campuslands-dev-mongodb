# Ejercicio 047 - MongoDB Facil: ropa urbana
...
```javascript
db.matches.insertOne({ nombre: 'demo-47', puntos: 329, activo: true })
```

```javascript
db.matches.find({ puntos: { $gte: 235 } }, { nombre: 1, puntos: 1, _id: 0 })
```
