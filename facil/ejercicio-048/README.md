# Ejercicio 048 - MongoDB Facil: viajes
...
```javascript
db.inventory.insertOne({ nombre: 'demo-48', puntos: 336, activo: true })
```

```javascript
db.inventory.find({ puntos: { $gte: 240 } }, { nombre: 1, puntos: 1, _id: 0 })
```
