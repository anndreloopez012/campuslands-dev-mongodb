# Ejercicio 022 - MongoDB Facil: paracaidismo
...
```javascript
use campus_paracaidismo
```

```javascript
db.movies.insertOne({ nombre: 'demo-22', puntos: 154, activo: true })
```

```javascript
db.movies.find({ puntos: { $gte: 110 } }, { nombre: 1, puntos: 1, _id: 0 })
```
